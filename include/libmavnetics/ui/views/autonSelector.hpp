...
public:
   ...
   */
  AutonSelector(std::string name, std::vector<routine_t> autons);

  /**
   * @brief Create autonomous selector
   * @param autons Vector of autonomous rotuines
   */
  AutonSelector(std::vector<routine_t> autons);
   ...
   * @param wrap_around Whether to wrap around to the beginning once the last
   * auton is reached
   *
   * Selects the next auton in the list for use with physical buttons such as
   * limit switches.
   */
   ...
   * @param wrap_around Whether to wrap around to the end once the first auton
   * is reached
   *
   * Selects the previous auton in the list for use with physical buttons such
   * as limit switches.
   */
